Diremos que se tiene una base sobre un [[espacios vectoriales|espacio vectorial]] si sus vectores equivalen a un [[generador]] del espacio vectorial y es un conjunto **linealmente independiente**. 
